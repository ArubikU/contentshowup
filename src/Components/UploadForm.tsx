...
\`\`\`
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto bg-white dark:bg-gray-800 text-gray-700 dark:text-white dark:border-transparent dark:outlite-transparent">
      <CardHeader>
        <CardTitle className="text-gray-900 dark:text-white">{GetLang(lang, "uploadForm.title")}</CardTitle>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4 dark:border-transparent dark:outlite-transparent">
          <div className="space-y-2 ">
            ...
            <Input
              ...
              required
              className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent"
            />
          </div>
          <div className="space-y-2 ">
          ...
          <div className="space-y-2 ">
            ...
            <Select name="loader" value={formData.loader} onValueChange={(value) => setFormData(prev => ({ ...prev, loader: value }))}>
              <SelectTrigger className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent">
                <SelectValue placeholder={GetLang(lang, "uploadForm.selectLoader")} />
              </SelectTrigger>
              <SelectContent className="bg-white dark:bg-gray-700">
                <SelectItem className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent hover:bg-gray-100 dark:hover:bg-gray-600" value="Datapack">{GetLang(lang, "uploadForm.datapack")}</SelectItem>
                <SelectItem className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent hover:bg-gray-100 dark:hover:bg-gray-600" value="Fabric">{GetLang(lang, "uploadForm.fabric")}</SelectItem>
                <SelectItem className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent hover:bg-gray-100 dark:hover:bg-gray-600" value="Forge">{GetLang(lang, "uploadForm.forge")}</SelectItem>
                <SelectItem className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent hover:bg-gray-100 dark:hover:bg-gray-600" value="Ignite">{GetLang(lang, "uploadForm.ignite")}</SelectItem>
                <SelectItem className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white dark:border-transparent dark:outlite-transparent hover:bg-gray-100 dark:hover:bg-gray-600" value="Resourcepack">{GetLang(lang, "uploadForm.resourcepack")}</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
